...
#import <Raster/MTIBlendModes.h>
#import <Raster/MTIAlphaType.h>
#else
#import "MTIFilter.h"
...
/// Specifies the maximum color-component value used by the blend operation. The default value is `1`.
