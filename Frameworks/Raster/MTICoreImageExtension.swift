...
#if SWIFT_PACKAGE
@_implementationOnly import RasterObjectiveC.Extension
#else
@_implementationOnly import Raster.Extension
#endif

/// `MTICoreImageKernel` provides the ability to use CoreImage filters with Raster with little or no overhead.
