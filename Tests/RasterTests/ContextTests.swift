...
final class ContextTests: XCTestCase {
    ...
    func testPixelBufferRenderingAPIRasterCompatibilityAlias() {
        XCTAssertEqual(MTICVPixelBufferRenderingAPI.raster.rawValue, 1)
        XCTAssertEqual(MTICVPixelBufferRenderingAPI.metalPetal.rawValue, 1)
        XCTAssertEqual(MTICVPixelBufferRenderingAPI.default.rawValue, 1)
    }
}
